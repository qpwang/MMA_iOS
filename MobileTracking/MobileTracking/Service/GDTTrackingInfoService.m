...
@implementation GDTTrackingInfoService

+ (GDTTrackingInfoService *)sharedInstance {
    static GDTTrackingInfoService *_sharedInstance = nil;
...
//    NetworkStatus status = [[GDT_Reachability reachabilityForLocalWiFi] currentReachabilityStatus];
    NetworkStatus status = [[GDT_Reachability reachabilityForInternetConnection] currentReachabilityStatus];
