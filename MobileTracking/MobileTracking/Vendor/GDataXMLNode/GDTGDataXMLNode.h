...
typedef NSUInteger GDTGDataXMLNodeKind;

@interface GDTGDataXMLNode : NSObject <NSCopying> {
@protected
...
@interface GDataXMLElement : GDTGDataXMLNode
...
- (GDTGDataXMLNode *)attributeForLocalName:(NSString *)name URI:(NSString *)attributeURI;
