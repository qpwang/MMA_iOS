...
@implementation GDTVAMonitorConfig

+ (instancetype)defaultConfig {
    return [[GDTVAMonitorConfig alloc] init];
}
...
- (instancetype)copyWithZone:(NSZone *)zone {
    GDTVAMonitorConfig *obj = [[[self class] alloc] init];
